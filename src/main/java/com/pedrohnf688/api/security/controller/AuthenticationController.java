...
public class AuthenticationController {
	...
	public ResponseEntity<Response<TokenDto>> gerarTokenJwt(@Valid @RequestBody JwtAuthenticationDto authenticationDto,
		...
		r.addHeader("UsuarioPerfil",String.valueOf(credencial.get().getUsuario().getTipoUsuario()));
		
		response.setData(new TokenDto(token, String.valueOf(credencial.get().getUsuario().getTipoUsuario()), credencial.get().getUsuario().getId()));
	...
	public ResponseEntity<Response<TokenDto>> gerarRefreshTokenJwt(HttpServletRequest request) {
		...
		response.setData(new TokenDto(refreshedToken, null, (Long) null));
